...
public class AccessControlAspectBankAccount {
    private final UserService userService;
    @Pointcut("execution(* com.example.bankaccounts.controller.BankAccountController.getUserByAccount(..)) || " +
            "execution(* com.example.bankaccounts.controller.BankAccountController.getUserByCard(..)) || " +
            "execution(* com.example.bankaccounts.controller.BankAccountController.getUserByDeposite(..))")
